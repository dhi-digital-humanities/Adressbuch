...
La base de données par défault est **Wikidata** en anglais, la langue peut être modifiée en modifiant l´url de réconciliation. Grâce à la liste de service de réconciliation disponible à cette adresse : 
*https://reconciliation-api.github.io/testbench/* nous pouvons ajouter d´autres bases de données externe comme **GND**, **VIAF**, **Geonames** ou d´autres.  
